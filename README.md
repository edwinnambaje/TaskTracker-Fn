# Task Tracker [![Github Actions](https://github.com/edwinnambaje/TaskTracker-Fn/actions/workflows/action.yml/badge.svg)](https://github.com/edwinnambaje/TaskTracker-Fn/actions/workflows/action.yml)
